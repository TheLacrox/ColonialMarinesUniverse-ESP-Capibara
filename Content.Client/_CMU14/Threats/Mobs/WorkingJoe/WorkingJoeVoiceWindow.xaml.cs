...
public sealed partial class WorkingJoeVoiceWindow : DefaultWindow
{
    ...
    private Button? _favoritesCategoryButton;
    private Button? _recentCategoryButton;
    ...
    private void RebuildCategories()
    {
        ...
        {
            Text = CMULocExtension.GetString("cmu-voice-category-all", "All"),
            HorizontalExpand = true,
            ToggleMode = true,
            Pressed = _selectedCategory == null && !_showFavorites
        };
        _allCategoryButton = allButton;
        ...
        {
            Text = CMULocExtension.GetString("cmu-working-joe-favorites", "★ Favorites"),
            HorizontalExpand = true,
            ToggleMode = true,
            Pressed = _showFavorites
        };
        _favoritesCategoryButton = favButton;
        ...
        {
            Text = CMULocExtension.GetString("cmu-working-joe-recent", "⏲ Recent"),
            HorizontalExpand = true,
            ToggleMode = true,
            Pressed = _selectedCategory == "__recent"
        };
        _recentCategoryButton = recentButton;
        ...
        if (questionCategories.Count > 0)
        {
            ...
            var label = new Label
            {
                Text = CMULocExtension.GetString("cmu-working-joe-questions", "Questions"),
    ...
    private void UpdateCategoryButtonStates()
    {
        foreach (Control child in CategoryList.Children)
        {
            ...
            if (ReferenceEquals(btn, _allCategoryButton))
                btn.Pressed = _selectedCategory == null && !_showFavorites;
            else if (ReferenceEquals(btn, _favoritesCategoryButton))
                btn.Pressed = _showFavorites;
            else if (ReferenceEquals(btn, _recentCategoryButton))
    ...
    private void RebuildList()
    {
        ...
        foreach (WorkingJoeVoiceLine line in filtered)
        {
            ...
            var favButton = new Button
            {
                ...
                MaxWidth = 30,
                ToolTip = isFav
                    ? CMULocExtension.GetString("cmu-working-joe-remove-favorite", "Remove from favorites")
                    : CMULocExtension.GetString("cmu-working-joe-add-favorite", "Add to favorites")
            };
        ...
        if (!filtered.Any())
        {
            ...
            {
                Text = CMULocExtension.GetString("cmu-voice-no-results", "No results."),
