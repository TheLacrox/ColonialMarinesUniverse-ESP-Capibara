...
public sealed partial class RoadmapItem : Control
{
    ...
    public RoadmapItemState ItemState
    {
        ...
        set
        {
            ...
            {
                RoadmapItemState.Planned => CMULocExtension.GetString(
                    "cmu-rmc-roadmap-state-planned",
                    "PLANNED"),
                RoadmapItemState.InProgress => CMULocExtension.GetString(
                    "cmu-rmc-roadmap-state-in-progress",
                    "IN PROGRESS"),
                RoadmapItemState.Partial => CMULocExtension.GetString(
                    "cmu-rmc-roadmap-state-partial",
                    "PARTIALLY IMPLEMENTED"),
                RoadmapItemState.Complete => CMULocExtension.GetString(
