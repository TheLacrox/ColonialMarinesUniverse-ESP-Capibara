...
admin-explosion-eui-label-spawn = ¡Catapum!

cmd-explosionui-desc = Abre una ventana que facilita la destrucción de la estación.
cmd-explosionui-help = Uso: explosionui

cmd-explosion-desc = El tren hace bum
cmd-explosion-help = Uso: explosion [intensidad] [pendiente] [intensidadMáxima] [x y] [idMapa] [idPrototipo]
cmd-explosion-failed-to-parse-intensity = No se pudo interpretar la intensidad: {$value}
cmd-explosion-failed-to-parse-float = No se pudo interpretar el número decimal: {$value}
cmd-explosion-failed-to-parse-coords = No se pudieron interpretar las coordenadas: {$value1} {$value2}
cmd-explosion-failed-to-parse-map-id = No se pudo interpretar el ID de mapa: {$value}
cmd-explosion-need-coords-explicit = No se pudieron obtener el mapa o las coordenadas predeterminadas mediante la transformación del jugador. Debes especificarlos de forma explícita.
