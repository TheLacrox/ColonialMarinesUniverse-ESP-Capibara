permissions-eui-do-not-have-required-flags-to-edit-admin-tooltip = No tienes los permisos necesarios para editar a este administrador.
...
permissions-eui-menu-add-admin-button = Añadir administrador
permissions-eui-menu-add-admin-rank-button = Añadir rango de administrador
...
permissions-eui-menu-admin-ranks-tab-title = Rangos de administrador
permissions-eui-edit-admin-window-edit-admin-label = Editar al administrador {$admin}
permissions-eui-edit-admin-window-name-edit-placeholder = Nombre de usuario/ID de usuario
permissions-eui-edit-admin-window-title-edit-placeholder = Título personalizado; déjalo en blanco para heredar el título del rango.
...
permissions-eui-edit-admin-rank-window-title = Editar rango de administrador
permissions-eui-edit-admin-window-save-button = Guardar
permissions-eui-edit-admin-window-remove-flag-button = Eliminar

cmd-permissions-desc = Abre el panel de permisos de administración.
