...
atmos-alerts-window-other-gases-value-nil = Ninguno
atmos-alerts-window-silence-alerts = Silenciar las alertas de esta alarma

atmos-alerts-window-label-alert-types = Niveles de alerta:
...
atmos-alerts-window-invalid-state = Inactiva

atmos-alerts-window-no-active-alerts = [font size=16][color=white]No hay alertas activas -[/color] [color={$color}]Situación normal[/color][/font]
...
atmos-alerts-window-toggle-overlays = Alternar visualización de alarmas

atmos-alerts-window-flavor-left = Contacta con un técnico de atmósfera para recibir ayuda
