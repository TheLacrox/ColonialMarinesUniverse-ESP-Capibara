...
comp-gas-tank-examine-open-valve = La válvula de salida de gas está [color=red]abierta[/color].
comp-gas-tank-examine-closed-valve = La válvula de salida de gas está [color=green]cerrada[/color].
...
gas-tank-window-internal-text = Sistema interno: {$status}
