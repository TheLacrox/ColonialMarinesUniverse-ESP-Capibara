bounty-console-menu-title = Consola de recompensas de suministros
...
bounty-console-id-label = ID n.º {$id}

bounty-console-flavor-left = Recompensas procedentes de comerciantes locales sin escrúpulos.
bounty-console-flavor-right = v1.4

bounty-manifest-header = [font size=14][bold]Manifiesto oficial de recompensa de suministros[/bold] (ID n.º {$id})[/font]
...
bounty-console-history-empty-label = No se encontró un historial de recompensas
