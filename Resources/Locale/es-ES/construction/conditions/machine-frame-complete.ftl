construction-condition-machine-container-empty = Retira las piezas del armazón con una [color=cyan]palanca[/color].
...
construction-step-condition-machine-frame-board = Tendrás que insertar una placa de máquina.
construction-step-condition-machine-frame-parts = Después, inserta todas las piezas necesarias.
