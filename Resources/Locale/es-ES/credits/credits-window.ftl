...
credits-window-patrons-tab = Mecenas
...
credits-window-become-patron-button = Convertirse en mecenas
...
credits-window-original-remake-team-section-title = Equipo original de la adaptación de Space Station 13
...
credits-window-attributions-copyright = [color=white]Derechos de autor:[/color] {$copyright}
...
credits-window-attributions-failed = [color=red]No se pudo leer el archivo:[/color] {$file}
