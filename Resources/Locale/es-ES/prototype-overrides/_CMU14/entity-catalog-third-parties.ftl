...
ent-AU14SquadIASF = IASF

ent-AU14SquadLACNCommando = Comando de la LACN

ent-AU14SquadMSG = guardia marine

ent-AU14SquadRMCRRT = RRT

ent-AU14SquadTD = defensa territorial

ent-AU14SquadUACG = Guardia Colonial

ent-AU14SquadUSArmy = US Army

ent-AU14SquadUSArmy32nd = 32.ª Blindada
...
ent-SquadHRT = equipo de respuesta a riesgos Prodigy

ent-SquadPARTS = Equipo Armado de Reparaciones Sierra de Prodigy

ent-SquadPARTY = Equipo Armado de Reparaciones Yankee de Prodigy

ent-SquadPET = Equipo de Extracción de Prodigy
...
ent-AU14SatchelFilledDrugs = bolsa de cuero
    .desc = Una bandolera muy elegante hecha de cuero fino. Parece bastante cara.

ent-AU14SatchelFilledDrugsAlt = bolsa de cuero
    .desc = Una bandolera muy elegante hecha de cuero fino. Parece bastante cara.

ent-AU14IDCardSquadK9Handler = tarjeta ID de guía k9
...
ent-AU14SpawnPointGOVFORK9Handler = (NO MAPEAR) Punto de aparición del cuidador K9 de GOVFOR
...
ent-AU14SpawnPointOPFORK9Handler = (NO MAPEAR) Punto de aparición del adiestrador K9 de OPFOR
    .desc = Un generador de puesto de RMC14. Se utiliza al inicio de la ronda y para incorporaciones tardías.
    .suffix = aparición de puesto
...
ent-AU14SlingSatchelBlueFilledPizza = Macuto azul de bandolera
    ...
    .suffix = repartidor de pizza, lleno

ent-AU14M276ShotgunShellLoadingRigBlackVonBandolier = aparejo de carga de cartuchos de escopeta modelo M276
...
ent-RMCBeltHolsterRevolverVonBandolier = aparejo de funda de revólver general modelo M276
    .desc = La M276 es el equipo reglamentario de transporte de carga de la USCM. Consta de un cinturón modular con diversos enganches. Esta versión es universal y se ajusta a distintos revólveres, e incorpora seis bolsillos pequeños para cargadores rápidos. Huele levemente a heno.
    .suffix = lleno, profesor Von Bandolier

ent-RMCPouchMagazinePistolLargeVonBandolier = Bolsillo grande para cargadores de pistola
    .desc = Puede transportar muchos cargadores de pistola o cargadores rápidos de revólver.
    .suffix = lleno, profesor Von Bandolier

ent-RMCPouchMedkitVonBandolier = bolsa para botiquín médico
    .desc = Está fabricado específicamente para guardar artículos médicos.
    .suffix = lleno, profesor Von Bandolier
...
ent-AU14PouchMagazineLargeFilledM41A = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, M41A

ent-AU14PouchMagazineLargeFilledM41AMK2AP = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, M41A MK2 AP

ent-AU14PouchMagazineLargeFilledMAR40 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = Lleno, MAR40 ext

ent-AU14VAIBasePreset = preajuste base de VAI

ent-AU14VAISOBasePreset = preajuste básico de vaiso

ent-AU14WebbingBlackHEDP = Chaleco de correaje negro
    .desc = Un resistente chaleco negro de algodón sintético con muchos bolsillos para llevar todo lo que necesites y no puedas sostener con las manos.
    .suffix = Lleno, HEDP

ent-AU14WebbingMagazineFilledL42AAP = correaje para cargadores
    .desc = Correaje de synthcotton con tres bolsillos para tus cargadores.
    .suffix = lleno, L42A AP

ent-AU14WebbingMagazineFilledM41A = correaje para cargadores
    .desc = Correaje de synthcotton con tres bolsillos para tus cargadores.
    .suffix = Lleno, M41A MK2 Ext

ent-AU14WebbingMagazineFilledM41AE2 = correaje para cargadores
    .desc = Correaje de synthcotton con tres bolsillos para tus cargadores.
    .suffix = lleno, MAR50

ent-AU14WebbingMagazineFilledMAR40 = correaje para cargadores
    .desc = Correaje de synthcotton con tres bolsillos para tus cargadores.
    .suffix = Lleno, MAR40 ext

ent-AU14WebbingMagazineFilledMAR50 = correaje para cargadores
    .desc = Correaje de synthcotton con tres bolsillos para tus cargadores.
    .suffix = lleno, MAR50

ent-AU14VAIMGPreset = preajuste de ametrallador vai
...
ent-AU14BackpackWeYuSurvSatchelFilledFP9000 = mochila de combate We-Yu
    .desc = Una mochila pequeña y ligera para expediciones y operaciones de corto alcance, diseñada para el personal de seguridad y militar privado de Weyland-Yutani.
    .suffix = lleno, FP9000

ent-AU14BackpackWeYuSurvSatchelFilledM54C2 = mochila de combate We-Yu
    .desc = Una mochila pequeña y ligera para expediciones y operaciones de corto alcance, diseñada para el personal de seguridad y militar privado de Weyland-Yutani.
    .suffix = lleno, M54C2

ent-AU14BackpackWeYuSurvSatchelFilledNSG23 = mochila de combate We-Yu
    .desc = Una mochila pequeña y ligera para expediciones y operaciones de corto alcance, diseñada para el personal de seguridad y militar privado de Weyland-Yutani.
    .suffix = Lleno, NSG-23

ent-AU14PouchMagazineLargeFilledF44AA = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, F44AA

ent-AU14PouchMagazineLargeFilledFP9000 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, FP9000

ent-AU14PouchMagazineLargeFilledM54C2 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, M54C2

ent-AU14PouchMagazineLargeFilledNSG23 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = Lleno, NSG-23

ent-AU14WeYuSurvPistolPreset = Preajuste de pistola de superviviente WY

ent-AU14WYSurvRifleBackpackPreset = preajuste de mochila con fusil para superviviente de WeYu
...
ent-AU14JumpsuitVeteranPMCCorporateShotgun = uniforme de seguridad corporativa We-Yu
    ...
    .suffix = WEYU, superviviente, correaje,

ent-RMCWebbingShotgunSurv = Chaleco de correaje negro
    .desc = Un resistente chaleco negro de algodón sintético con muchos bolsillos para llevar todo lo que necesites y no puedas sostener con las manos.
    .suffix = Lleno, WEYU
...
ent-AU14BeltConstructionCLFSurv = Aparejo de construcción del patrón M277
    ...
    .suffix = CLF; superviviente

ent-AU14BeltHolsterPistolFilledB92FS = arnés de funda de pistola general modelo M276
    ...
    .suffix = lleno, Beretta

ent-AU14BeltUtilityGeneralBlackCLFSurvGrenade = bolsa de uso general M276 G8-A
    .desc = Una bolsa pequeña y ligera. El nuevo modelo G8-A, aunque incómodo, también puede ceñirse a la cintura.
    .suffix = CLF; superviviente; granadas

ent-AU14BeltUtilityGeneralBlackCLFSurvMedical = bolsa de uso general M276 G8-A
    .desc = Una bolsa pequeña y ligera. El nuevo modelo G8-A, aunque incómodo, también puede ceñirse a la cintura.
    .suffix = CLF; superviviente; médico

ent-AU14BeltUtilityGeneralBlackCLFSurvMetal = bolsa de uso general M276 G8-A
    .desc = Una bolsa pequeña y ligera. El nuevo modelo G8-A, aunque incómodo, también puede ceñirse a la cintura.
    .suffix = CLF; superviviente; metal

ent-AU14BeltUtilityGeneralBlackCLFSurvMolly = bolsa de uso general M276 G8-A
    .desc = Una bolsa pequeña y ligera. El nuevo modelo G8-A, aunque incómodo, también puede ceñirse a la cintura.
    .suffix = CLF; superviviente; cóctel molotov

ent-AU14BeltUtilityGeneralBlackCLFSurvPipeBomb = bolsa de uso general M276 G8-A
    .desc = Una bolsa pequeña y ligera. El nuevo modelo G8-A, aunque incómodo, también puede ceñirse a la cintura.
    .suffix = CLF; superviviente; bomba casera

ent-AU14PouchGeneralLargeFilledM60 = Bolsillo general grande
    .desc = Un bolsillo de uso general para llevar más objetos de distintos tamaños.
    .suffix = Lleno, M60

ent-AU14PouchGeneralLargeFilledMAR50 = Bolsillo general grande
    .desc = Un bolsillo de uso general para llevar más objetos de distintos tamaños.
    .suffix = lleno, MAR50

ent-AU14PouchMagazineLargeFilledAR10 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = Lleno, AR10

ent-AU14PouchMagazineLargeFilledHuntingRifle = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, Basira

ent-AU14PouchMagazineLargeFilledM16 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, M16

ent-AU14PouchMagazineLargeFilledMAR40normal = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, MAR40

ent-AU14PouchMagazineLargeFilledType71 = Bolsillo grande para cargadores
    .desc = Puede transportar muchos cargadores.
    .suffix = lleno, Type71

ent-CMJumpsuitColonistCLFArmband = uniforme de colono
    .desc = Un elegante mono verde grisáceo, reglamentario para los colonos.
    .suffix = CLF, superviviente, brazalete

ent-CMJumpsuitTShirtGrayCLFArmband = Camiseta gris
    .desc = Un sencillo conjunto de camiseta y pantalón.
    .suffix = CLF, superviviente, brazalete

ent-CMJumpsuitTShirtWhiteCLFArmband = camiseta blanca
    .desc = Un sencillo conjunto de camiseta y pantalón.
    .suffix = CLF, superviviente, brazalete

ent-RMCJumpsuitCivilianCLFArmband = uniforme de faena gris
...
ent-AU14BeltHolsterPistolCMBHG45 = cinturón de pistola
    ...
    .suffix = CMB, lleno, HG45

ent-AU14SatchelCMBShotgun = mochila policial UPE-4
...
ent-AU14BeltSmartGunOperatorPistolForeconFilled = aparejo para arma secundaria de operador de smartgun modelo M802
    .desc = El M802 es una variante de entrega limitada del equipo de carga de la USCM, diseñada para llevar munición de Smartgun y un arma corta.
    .suffix = completo, AU14, FORECON
...
ent-AU14BeltHolsterPistolLACNTPR23B = cinturón de pistola
    .desc = Un cinturón de cuero marrón oscuro para pistola. Admite la mayoría de armas cortas junto con cargadores de repuesto. Es equipo estándar entre las fuerzas del orden, militares y de seguridad.
    .suffix = LACN, lleno, TPR23B

ent-AU14LACNBackpackSniper = mochila de peso estándar de LACN
    ...
    .suffix = lleno, LACN, francotirador

ent-AU14LACNBackpackSpotter = mochila de peso estándar de LACN
    .desc = La mochila reglamentaria de las fuerzas de desembarco de la LACN. Está diseñada para llevar equipo al campo de batalla.
    .suffix = Lleno, LACN, observador

ent-AU14PouchSlingBinocs = correa portafusil
    .desc = Mantiene un solo objeto sujeto a una correa.
    .suffix = lleno, designador láser

ent-AU14PouchSlingBinocsTwo = correa portafusil
    .desc = Mantiene un solo objeto sujeto a una correa.
...
ent-AU14RMCRRTBackpackBreacher = mochila pequeña de los Royal Marines
    ...
    .suffix = lleno, RMC, RRT, artificiero

ent-AU14RMCRRTBackpackCommander = mochila pequeña de los Royal Marines
    .desc = La mochila reglamentaria de las fuerzas de la TWE. Diseñada para cargar equipo hasta el campo de batalla.
    .suffix = Lleno, RMC, RRT, comandante

ent-AU14RMCRRTBackpackMarksman = mochila pequeña de los Royal Marines
    .desc = La mochila reglamentaria de las fuerzas de la TWE. Diseñada para cargar equipo hasta el campo de batalla.
    .suffix = Lleno, RMC, RRT, tirador designado

ent-AU14RMCRRTBackpackRifleman = mochila pequeña de los Royal Marines
    .desc = La mochila reglamentaria de las fuerzas de la TWE. Diseñada para cargar equipo hasta el campo de batalla.
    .suffix = lleno, RMC, RRT, fusilero

ent-AU14RMCRTTPouchMagazineL90A2 = bolsa para cargadores
    .desc = Puede llevar cargadores.
    .suffix = lleno, RMC, RRT, L90A2

ent-RMCBeltSmartGunOperatorPistolFilledL165A1 = aparejo para arma secundaria de operador de smartgun modelo M802
    .desc = El M802 es una variante de entrega limitada del equipo de carga de la USCM, diseñada para llevar munición de Smartgun y un arma corta.
    .suffix = lleno, RMC, RRT, L165A1

ent-RMCPouchDrumPMCFilled = bolsa para tambor de ametralladora inteligente
    .desc = Un bolsillo pesado diseñado para llevar una gran cantidad de tambores de smartgun.
...
ent-AU14BackpackAmmoRCMSurvL90 = armazón de carga RCM
    ...
    .suffix = superviviente, L90

ent-AU14BeltUtilityCombatRMCFilledSurvivor = cinturón de herramientas de combate modelo L177
    ...
    .suffix = Warwick MKVII, lleno

ent-AU14BoxMagazineRifleL90 = caja de cargadores (L90 x 12)
    .desc = Una caja de cargadores de fusil.
    .suffix = lleno

ent-AU14BoxMagazineRifleL90Empty = caja de cargadores (L90 x 12)
    .desc = Una caja de cargadores de fusil.

ent-AU14IASFPouchMagazineL90A2 = bolsa para cargadores
    .desc = Puede llevar cargadores.
    .suffix = lleno, IASF, L90A2

ent-AU14JumpsuitIASFL90 = Uniforme de combate paramarine
    .desc = BDU del patrón No.8 utilizado por los regimientos Paramarine de la RCM. Tiene el mismo corte y protección que los uniformes reglamentarios estándar, pero se entrega con camuflaje boscoso. Su malla ligera de Kevlar ofrece protección limitada contra la metralla y las amenazas a corta distancia.
    .suffix = correaje, L90

ent-AU14JumpsuitIASFL90A2 = Uniforme de combate paramarine
    .desc = BDU del patrón No.8 utilizado por los regimientos Paramarine de la RCM. Tiene el mismo corte y protección que los uniformes reglamentarios estándar, pero se entrega con camuflaje boscoso. Su malla ligera de Kevlar ofrece protección limitada contra la metralla y las amenazas a corta distancia.
    .suffix = correaje, L90A2

ent-AU14RMCRTTPouchMagazineL90 = bolsa para cargadores
    .desc = Puede llevar cargadores.
    .suffix = Lleno, L90A

ent-AU14WebbingIASFL90 = correaje de la IASF
    .desc = Un resistente sistema de arnés suministrado a los Paramarines de la RCM, diseñado para repartir el peso de forma uniforme y ofrecer comodidad y movilidad. Incluye bolsillos reforzados para llevar equipo esencial durante inserciones de alto riesgo.
    .suffix = lleno, L90

ent-AU14WebbingIASFL90A2 = correaje de la IASF
    .desc = Un resistente sistema de arnés suministrado a los Paramarines de la RCM, diseñado para repartir el peso de forma uniforme y ofrecer comodidad y movilidad. Incluye bolsillos reforzados para llevar equipo esencial durante inserciones de alto riesgo.
    .suffix = lleno, L90A2

ent-RMCPouchConstructionSurvivor = bolsillo de construcción
    ...
    .suffix = superviviente, lleno

ent-RMCSatchelLightpackFilledParaSL = mochila de combate ligera
    .desc = Una mochila pequeña y ligera para expediciones y operaciones de corto alcance.
...
ent-AU14UACGAmmoBearerBelt = bolsa de uso general M276 G8-A
    ...
    .suffix = UACG, cinturón

ent-AU14UACGBeltFilledM20a = arnés de carga de munición modelo M276
    .desc = La M276 es el equipo reglamentario de transporte de carga de la USCM. Consta de un cinturón modular con diversos enganches. Esta es la variante estándar, diseñada para operaciones de transporte de grandes cantidades de munición.
    .suffix = UACG, lleno, M20a

ent-AU14UACGCigPouch = Bolsillo general grande
    .desc = Un bolsillo de uso general para llevar más objetos de distintos tamaños.
    .suffix = UACG, lleno, cigarrillos

ent-AU14UACGPatrolRucksack = mochila IMP de logística
    .desc = Una mochila reglamentaria que utiliza el personal de logística. En ocasiones también se entrega al personal de combate para expediciones prolongadas e incursiones en el espacio profundo.
    .suffix = UACG, mochila

ent-AU14UACGPatrolRucksackAmmobearer = mochila IMP de logística
    .desc = Una mochila reglamentaria que utiliza el personal de logística. En ocasiones también se entrega al personal de combate para expediciones prolongadas e incursiones en el espacio profundo.
    .suffix = UACG, mochila, portamunición

ent-AU14UACGPouchFilledM20a = bolsa para cargadores
    .desc = Puede llevar cargadores.
    .suffix = UACG, lleno, M20a

ent-AU14BeltHolsterPistolUPPFull = aparejo con funda de pistola Type 47
    .desc = Este arnés para arma corta diseñado por la UPP permite guardar un Type-73, un NP92 o un ZHNK-72, junto con sus cargadores o cargadores rápidos, de forma muy ceñida y segura. Sin embargo, ofrece poca versatilidad en las armas que admite.
    .suffix = Completo, T74, GROM

ent-AU14BeltMedicalUPPFull = aparejo de almacenamiento médico modelo Type 41
...
ent-AU14BeltMedicalUPPFullSupportTech = aparejo de almacenamiento médico modelo Type 41
    .desc = El Type 41 es el equipo de carga reglamentario del ejército de la UPP. Está formado por un cinturón modular con distintos clips. Esta versión es una configuración menos habitual, diseñada para transportar suministros médicos. Haz clic derecho en su sprite y pulsa \"alternar modo del cinturón\" para sacar pastillas de los botes con solo hacer clic en ellos.
    .suffix = Completo, GROM

ent-AU14BeltSmartGunOperatorPistolUPPFull = aparejo de arma secundaria para ametrallador de patrón Type 92
    ...
    .suffix = completo, GROM, T74

ent-AU14FatiguesUPPGROM = uniforme de campaña de infantería naval de la UPP
    .desc = Un uniforme de faena estándar de la Unión de Pueblos Progresistas. Incorpora fragmentos de kevlar ligero para proteger contra metralla. Este lleva sangre y desgarrones de innumerables batallas.
    .suffix = AU14, GROM

ent-AU14PouchPistolAltFull = bolsa para arma secundaria
    .desc = Podrías llevar una pistola aquí; más importante aún, podrías desenfundarla con rapidez. Útil para emergencias.
    .suffix = completo, GROM, T74

ent-AU14ShotgunShellLoadingRigUPPFull = arnés de carga de cartuchos de escopeta modelo Type 42
    .desc = Un cinturón de munición diseñado para llevar cartuchos de escopeta, principalmente para la Type 23.
    .suffix = Completo, GROM

ent-AU14WebbingDropPouchUPPFull = bolsa desplegable de marine de la UPP
    .desc = Un práctico bolsillo para transportar objetos sueltos.
    .suffix = Completo, GROM

ent-RMCHeadsetGROM = auriculares SOF de la UPP
    .desc = Entregados exclusivamente a fuerzas especiales de la UPP como Kommando Spezialkrafte y GROM.
    .suffix = GROM

ent-RMCOuterClothingExternalWebbingBrownFull = correaje exterior
    .desc = Diseñado para llevarse sobre un mono en lugar de engancharse.
    .suffix = completo, palanca

ent-RMCPouchCommandFull = bolsillo de mando
...
ent-RMCPouchMagazineUPPFull = bolsa para cargadores
    .desc = Puede llevar cargadores.
    .suffix = lleno, GROM, AG80

ent-RMCSatchelSPPFull = mochila de combate UCP3
    .desc = Una mochila de combate Union MK3, reglamentaria en el ejército de la UPP.
    .suffix = Completo, GROM

ent-RMCSatchelSPPFullMachinegunner = mochila de combate UCP3
    .desc = Una mochila de combate Union MK3, reglamentaria en el ejército de la UPP.
    .suffix = Completo, GROM

ent-RMCSatchelSPPFullMarksman = mochila de combate UCP3
    .desc = Una mochila de combate Union MK3, reglamentaria en el ejército de la UPP.
    .suffix = Completo, GROM
...
ent-AU14BeltHolsterPistolUSArmyFull = arnés de funda de pistola general modelo M276
    .desc = El M276 es el equipo de carga estándar del USCM. Consta de un cinturón modular con distintos enganches. Esta versión tiene una funda que permite llevar las pistolas más habituales, además de bolsillos laterales para casi cualquier cargador de pistola.
    .suffix = Completo, AU14, Ejército de EE. UU.
