sandbox-window-title = Panel del modo sandbox
...
sandbox-window-spawn-entities-button = Crear entidades
sandbox-window-spawn-tiles-button = Crear casillas
sandbox-window-spawn-decals-button = Crear calcomanías
sandbox-window-grant-full-access-button = Conceder acceso completo
sandbox-window-ghost-button = Convertirse en fantasma
...
sandbox-window-toggle-suicide-button = Suicidarse
sandbox-window-show-spawns-button = Mostrar puntos de aparición
