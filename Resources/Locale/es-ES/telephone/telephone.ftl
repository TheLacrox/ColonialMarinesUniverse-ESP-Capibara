# Formato de mensajes telefónicos en el chat (prefijo y sufijo)
...
chat-telephone-unknown-caller = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Llamada desconocida[/bolditalic][/font][/color]
...
chat-telephone-unknown-device = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Origen desconocido[/bolditalic][/font][/color]
