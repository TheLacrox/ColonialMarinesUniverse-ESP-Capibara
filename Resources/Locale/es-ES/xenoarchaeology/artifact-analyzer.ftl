analysis-console-menu-title = Consola de análisis Mark 3 de amplio espectro
...
analysis-console-info-no-artifact = ¡No hay ningún artefacto! Coloca uno sobre la plataforma para ver la información de sus nodos.
analysis-console-info-ready = Sistemas operativos. Listos para escanear.
...
analysis-console-extract-none = [font="Monospace" size=11][color=orange] Ningún nodo desbloqueado conserva puntos que extraer [/color][/font]
analysis-console-extract-sum = [font="Monospace" size=11][color=orange]Investigación total: {$value}[/color][/font]

analyzer-artifact-extract-popup = ¡La energía reluce sobre la superficie del artefacto!
